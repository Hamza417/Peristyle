...
fun WallpaperList(navController: NavController? = null) {
    ...
    if (folder != null) {
        ...
        val wallpapers = folderDataViewModel.getWallpapers().observeAsState().value ?: emptyList()
        ...
        Box(
            ...
            LazyVerticalGrid(
                ...
                item(span = { GridItemSpan(maxLineSpan) }) {
                    TopHeader(title = folder.name ?: stringResource(R.string.unknown), count = wallpapers.size,
